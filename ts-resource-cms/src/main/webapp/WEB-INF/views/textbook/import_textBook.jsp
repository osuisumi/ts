...
<form id="importTextbookForm">
		...
		<tbody>
			<tr>
				...
				<td width="35%" style="text-align: left; height: 100px;">
					...
					<p><a href="###" onclick="downloadExcel('import_textbook.xls')" style="color: orange">模板下载</a></p>
				</td>
			</tr>
		</tbody>
	</table>
	...
	<div style="text-align: center">
		<button type="button" onclick="importTextbook()" class="easyui-linkbutton">
...
<script type="text/javascript">
	...
	function importTextbook() {
		...
		$('#layout_center_tabs').tabs('getSelected').panel('refresh','${ctx}/textBook/importTextBook?'+$('#importTextbookForm').serialize());
		easyui_modal_close('importTextbookDiv');
	}
</script>