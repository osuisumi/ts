...
<form id="listMenuForm">
	...
	<table data-options="idField:'id',treeField:'text',singleSelect:false,checkOnSelect:true,selectOnCheck:true,pagination:'true',pageList:[10]" id="listMenuTable" class="" >
	 	<thead>
			<tr>
				<th width="10" data-options="field:'id',checkbox:true"></th>
				<th width="30%" data-options="field:'text'">菜单名称</th>
	...
	$('#listMenuTable').treegrid({
		onBeforeLoad:function(row,param){
			if(row){
				...
				//查子菜单
				$(this).treegrid('options').url='${ctx}/menu/tree?paramMap[parentIsNull]=Y';
			}
		}
	})
</script>